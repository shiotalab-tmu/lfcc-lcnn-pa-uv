...
#  about the data sets
trn_set_name = "jspaw-pa"
val_set_name = "jspaw-pa-val"

# for convenience
#  we will use resources in this directory
tmp = os.path.dirname(__file__) + "/../DATA/jspaw"

# File lists (text file, one data name per line, without name extension)
# train_file_list: list of files for training set
